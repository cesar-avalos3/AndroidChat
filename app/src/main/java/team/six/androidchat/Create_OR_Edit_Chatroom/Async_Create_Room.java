...
public class Async_Create_Room  extends AsyncTask<String, Void, String>  {
     ...
     */
    public Async_Create_Room(Context c, boolean t, EditText text, StringBuffer  test_res) {
    ...
    /**
     * Initalizes all variables except the test variables
     *
     * @param c Context passed in
     * @param t - Boolean passed in
     */
    public Async_Create_Room(Context c, boolean t) {
    ...
    protected void onPostExecute(String results){
        ...
        if(test) {
            ...
            if(results.equals("true")) {
                ...
                test_result = test_result.append("Attempt to create a room that already exists passed:\n" +
                        " Passed\n");
            ...
            //If the task went through
                ...
                test_result = test_result.append("Attempt to create a room that doesnt already exist:\n" +
                        " Passed\n");
                test_screen.setText(test_result.toString());
